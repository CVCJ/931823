...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_accommodation_buffer_7,
      colName: 'name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-13489921.347820, 5475152.753291, -12086154.444859, 6588003.257357], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        OSMAttribution.innerHTML = '<a href="https://www.openstreetmap.org/copyright">© OpenStreetMap contributors</a> &middot; ';
